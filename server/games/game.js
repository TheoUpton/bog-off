export class Game {
    ...
    /** @returns {Omit<import('../server/lobby.js').ServerLobby, "api"> & {api:import("../public/shared/base-gameAPI.js").LobbyAPI}}} */
    ...
    /**@param {Omit<import("../server/user.js").User, "api"> & {api: import("../public/shared/base-gameAPI.js").ServerAPI}} user  */
